...
const emptyForm = { name: "", description: "", price: "", discountPrice: "", durationMinutes: 60, category: "" };
          ...
          <form onSubmit={handleSubmit} className="card mb-8 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. Hair Services, Beard Services, Combo Offers"
              />
          ...
          {loading ? (
            ...
            Object.entries(grouped).map(([cat, items]) => (
              <div key={cat} className="mb-8">
                <h3 className="font-display text-lg text-goldsoft mb-3">{cat}</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {items.map((s) => (
                    <div key={s._id} className="card">
                      {s.image?.url && (
